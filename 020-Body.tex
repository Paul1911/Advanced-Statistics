...
\section{a) A vote with outcome for or against follows a Bernoulli distribution where P(vote="for")=0.27. Represent the proportion of “for” and “against” in this single Bernoulli trial using a graphics, a percentage. Can an expectation be calculated? Justify your answer.}
