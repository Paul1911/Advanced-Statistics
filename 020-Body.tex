...
\begin{gather*}
x^2=r^2cos^2(\theta) \quad y^2=r^2sin^2(\theta)\\
...
and
\begin{gather*}
 r = \frac{x}{cos(\theta)} \quad r = \frac{y}{sin(\theta)}\\
...
To calculate their individual densities, the marginal distributions are needed. 
