...
%\usepackage{natbib} % for citations in APA
...
\setlength{\parindent}{0.0000pt} % Indent at start of paragraphs  6pt
...
\usepackage{minted} % for programming code

\usepackage{amsmath} % for correct display of fractions? 
